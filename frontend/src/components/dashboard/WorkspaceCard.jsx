...
const WorkspaceCard = ({ workspace }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 sm:px-8 py-10 bg-zinc-900 rounded-2xl shadow-xl w-full sm:w-[500px] md:w-[550px] lg:w-[650px] xl:w-[750px] 2xl:w-[850px] my-6 space-y-10 transition-all duration-300 hover:scale-[1.01] border border-zinc-800 hover:border-white/20">
